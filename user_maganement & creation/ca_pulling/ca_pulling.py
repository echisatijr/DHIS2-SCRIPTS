...
DHIS2_BASE_URL_TEST = os.getenv("DHIS2_BASE_URL_TEST")
USERNAME = os.getenv("DHIS2_USERNAME")
PASSWORD = os.getenv("DHIS2_PASSWORD")

if not DHIS2_BASE_URL_TEST:
    DHIS2_BASE_URL_TEST = input("Write the DHIS2 base URL (e.g., https://example.org/dhis): ")
if not USERNAME:
...
def get_level_3_org_unit_id_by_name(level_3_name):
    url = f"{DHIS2_BASE_URL_TEST}/api/organisationUnits.json"
    params = {
...
def save_org_units_to_excel(org_units, filename= f"../data/{district_name}_CA.xlsx"):
